...
public class Challenge3Test {
    ...
    private Challenge3 challenge3 = new Challenge3();
    ...
    public void solve() throws IOException {
        ...
        HashMap<String, Integer> output= challenge3.solve(inputList);

        assertEquals(new Integer(1),output.get("Kitchen"));
        assertEquals(new Integer(1),output.get("Electronics"));
    }
}